        ...
        <div style={{ flex: 1.07, overflow: 'hidden' }}>
          ...
          >
            <div>
              ...
              <h3 className="text-lg font-bold text-white mb-2">Policy-Gated Autonomy</h3>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between rounded-lg border border-white/10 bg-white/[0.03] p-2 text-xs">
                  <span className="flex items-center gap-2 text-neutral-200">
                    <CheckCircle2 className="h-3.5 w-3.5 text-[#4C6DFF]" /> Monitor — auto if low/medium
                  </span>
                  <span className="font-mono font-bold text-emerald-400">Threshold-gated</span>
                </div>
                <div className="flex items-center justify-between rounded-lg border border-white/10 bg-white/[0.03] p-2 text-xs">
                  <span className="flex items-center gap-2 text-neutral-200">
                    <CheckCircle2 className="h-3.5 w-3.5 text-[#4C6DFF]" /> Dismiss — capped ≤₹1k
                  </span>
                  <span className="font-mono text-sky-300">Human or cap</span>
                </div>
              </div>
            </div>
