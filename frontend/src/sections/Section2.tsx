      ...
      >
        ...
        <div style={{ flex: 1, position: 'relative' }}>
          <motion.div
            ...
            className="smoked-glass relative h-full w-full rounded-2xl p-5 flex flex-col justify-between border border-[#906AFF]/30 bg-[#090a0f]/90 shadow-2xl backdrop-blur-xl"
          >
            <div>
              <div className="mb-2 flex items-center justify-between gap-2">
                <span className="flex items-center gap-1.5 text-[11px] font-bold text-[#D4C4FF] uppercase tracking-wider">
                  <Network className="h-3.5 w-3.5 shrink-0 text-[#906AFF]" /> Intelligent Signal Correlation
                </span>
                <span className="shrink-0 rounded-full border border-[#906AFF]/30 bg-[#906AFF]/10 px-2 py-0.5 text-[9px] font-bold text-[#D4C4FF]">
                  Multi-Signal
                </span>
              </div>
            ...
            <div>
              <div className="mb-2 flex items-center justify-between gap-2">
                <span className="flex items-center gap-1.5 text-[11px] font-bold text-neutral-300 uppercase tracking-wider">
                  <Layers className="h-3.5 w-3.5 shrink-0 text-[#906AFF]" /> Unified Incident Timeline
                </span>
