  ...
  return <main className="min-h-screen overflow-x-hidden bg-[#040406] text-white">
    {viewMode === 'showcase' ? (
      <div className="relative">
        <Navbar viewMode={viewMode} onViewModeChange={setViewMode} environment={dashboard?.environment ?? 'test'} />
        <SpatialScroll />
      </div>
    ) : (
      <>
